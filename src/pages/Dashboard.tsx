...
const Dashboard: React.FC = () => {
  ...
  const stats = [
    ...
    { label: 'Total Spent', value: formatCurrency(shipments.reduce((acc, s) => acc + s.price, 0)), icon: Package, hide: isDriver },
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-primary">Welcome, {profile?.displayName}</h1>
          <p className="text-gray-500">Manage your logistics and track your deliveries.</p>
        </div>
